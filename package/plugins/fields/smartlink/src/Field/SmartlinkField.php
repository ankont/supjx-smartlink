...
class SmartlinkField extends FormField
{
    ...
    protected function getInput()
    {
        ...
        $encodedConfig = htmlspecialchars(
            (string) json_encode($config, JSON_UNESCAPED_SLASHES | JSON_UNESCAPED_UNICODE | JSON_INVALID_UTF8_SUBSTITUTE),
            ENT_COMPAT,
            'UTF-8'
        );
...
HTML;
    ...
    private function loadBuilderLanguage(): void
    {
        static $loaded = false;
        ...
        $language->load('plg_fields_smartlink', JPATH_ADMINISTRATOR);
        $language->load('plg_fields_smartlink', JPATH_SITE);
        $language->load('plg_fields_smartlink', JPATH_PLUGINS . '/fields/smartlink');
    ...
    private function getUiStrings(): array
    {
        return [
            ...
            'button_choose_image' => Text::_('PLG_FIELDS_SMARTLINK_UI_BUTTON_CHOOSE_IMAGE'),
